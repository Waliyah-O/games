...
window.addEventListener("load", function () {
  ...
  class Layer {
    constructor(image, speedModifier) {
      ...
      this.width = 2400;
      this.height = 700;
      this.image = image; //create property called image on this new object
      this.speedModifier = speedModifier;
      this.speed = gameSpeed * this.speedModifier;
    }
    //   move layers horizontally  by changing x and x2, reset x and x2 when the layers move off screen
    update() {
      this.speed = gameSpeed * this.speedModifier;
